describe('writing functions', () => {
    describe('how to create them', () => {
        it('the syntax', () => {
            ...
            // the only difference is that the named function essentially gets pulled to the
            // top of the block, so it can be called before it is established. The other two do not.
    ...
    describe('higher order functions', () => {
        ...
        describe('a high order function that returns a function', () => {
...
describe('a couple of examples', () => {
    it('working with something other than integers', () => {
        ...
        // YOUR CODE HERE
        // Using one statement, find all the vehciles that have more that 100_000 miles and give me the make and model as below.
